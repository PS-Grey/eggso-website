  ...
  return (
    <section id="overview" className="mb-20">
      ...
      <div className="mt-6 space-y-4 font-mono text-sm text-muted-foreground leading-relaxed max-w-2xl">
        <p>
          Eggso is a motorised elbow exoskeleton for rehabilitation exercise
          and adaptive strength training. Unlike conventional exoskeletons that assist
          movement, Eggso uses motors to provide controlled, programmable
          resistance that the user works against.
        </p>
        <p>
          The result is a wearable resistance machine with adjustable load curves.
          Resistance profiles update in real time based on joint angle, velocity,
          and muscle activity - adapting to the user's current capacity each rep.
        </p>
        <p>
          The first prototype was built from commodity components for under £200.
          It reads real-time sensor data and adjusts motor behaviour
          continuously - within a single rep.
        </p>
      </div>
